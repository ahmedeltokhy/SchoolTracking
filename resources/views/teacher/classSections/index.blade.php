                ...
                <tbody>
                    @foreach($classSections as $key => $classSection)
                        <tr data-entry-id="{{ $classSection->id }}">
                            ...
                            <td>
                                <a class="btn btn-xs btn-primary" href="{{ route('teacher.view_section', $classSection->id) }}">
                                        {{ trans('global.view') }}
                                </a>
                                <a class="btn btn-xs btn-danger" href="{{ route('teacher.attendances.create', ['classsection'=>$classSection->id]) }}">
                                        {{ trans('global.add_attendance') }}
                                </a>
